// -------------------------------------------------------------------------------------------------
// <copyright file="Disjunction.cs" author="Christopher Sellers">
...
namespace FuzzyLogic.Logic
{
    ...
    /// The conjunction.
    /// </summary>
    public class Disjunction : CompoundCondition, ICondition
    {
        /// <summary>
        ...
        /// The premise b.
        /// </param>
        public Disjunction(ILogicOperator connective, Premise premiseA, Premise premiseB) : base(premiseA, premiseB)
        {
